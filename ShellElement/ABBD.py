...
class D:
    ...
    def d(self, e_b, eb_, vb, e_s, vs, orientation, v01):
        ...
        :param e_b: Относительные деформации бетона по диаграмме
        :param eb_: Начальные модули упругости бетона в слоях, МПа
        :param vb: Коэффициент упругости арматурной бетона
        :param e_s: Относительные деформации арматурной стали по диаграмме
